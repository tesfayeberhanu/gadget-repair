...
export function InventoryView({ role, permissions = [], parts, dashboard = {}, createInventoryItem, updateInventoryItem, deleteInventoryItem, receiveInventoryStock }) {
