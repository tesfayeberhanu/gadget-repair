...
export default function CustomerPage() {
  ...
  const [siteContent, setSiteContent] = useState({ banners: [], socialLinks: [], staffProfiles: [] });
  ...
  return <div className="customer-site">
    <header className="customer-nav"><a href="#home" className="customer-brand"><img src="/ifixlab251-logo.png" alt="iFixLab251"/><span>iFixLab<span>251</span></span></a><nav><a href="#track">Track repair</a><a href="#appointment">Appointment</a><a href="#tips">Repair tips</a>{siteContent.staffProfiles.length > 0 && <a href="#team">Our team</a>}</nav></header>
    <main>
